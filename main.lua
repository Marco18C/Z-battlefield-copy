...
soldiers = {
    {
        ...
        magazine = {
            ...
            first  = {
                ...
                shootOffsetX=10,shootOffsetY=0,shootMaxDistance=2200,shootSpread=rad(1.5),objectDamagePercent=0.1, -- =0≡= config. raycast de disparo =≡0= --
    ...
    },
    {
        ...
        magazine = {
            ...
            first  = {
                ...
                HandOffX=610,HandOffY=0,size=.08,     -- =0≡= cambiar ubicación intena del arma =≡0= --
                shootOffsetX=80,shootOffsetY=-6,shootMaxDistance=2200,shootSpread=rad(1.5),objectDamagePercent=0.3, -- =0≡= config. raycast de disparo =≡0= --
                mode="auto",  -- auto - burst - semi  -- =O=≡=≡=≡=≡=≡=≡=≡=≡=≡=≡=≡=≡=≡=≡=≡=≡=≡=≡=≡=O= --
                pos="first", -- first - second
                fireRate=.05,fireTime=0,
                func=function(weapon)end,
            ...
            second = {
                offsetX=10,offsetY=304,damage=35,
                HandOffX=20,HandOffY=0,size=.035,
                shootOffsetX=40,shootOffsetY=-4,shootMaxDistance=1400,shootSpread=rad(0.5),objectDamagePercent=0.3,
                mode="semi", -- auto - burst - semi
                pos="second", -- first - second
                fireRate=.5,fireTime=0,
                img={
        ...
        parts = {
            dir = -1,
            torso = {
                x = 200, y = 300, w = 30, h = 20, rx = 0, ry = 0,
                shouldR = {x=0,y=-26}, shouldL = {x=0,y=26},
                hipR    = {x=0,y=-20}, hipL    = {x=0,y=20},
                _lastSafe = {
                    x=nil,
...
function love.load()
    ...
    gen.level = gen.src.load("testing", "default_test") -- carga del nivel
